...
public interface DriverFactory extends CafenatedFactory {
   ...
   */
  DialectSelector newDialectExpressionSelector(ConnectionType ct,
   ...
   *          the connection type
   * @param name
   *          the name used to identify the dialect to select.
   * @return the dialect selector
   */
   ...
   *          the parent dialect
   * @param name
   *          Name of the grammar definition
   ...
   *
   * @param nn
   *          the noun to which the verb can apply
   * @param name
   *          the name
   * @return the verb definition
   */
   ...
   *
   * @param gg
   *          the grammar to which the noun belongs.
   * @param name
   ...
   *
   * @param driver
   *          the driver to which the definition applies
   * @param name
   *          the name the name of the dialect
