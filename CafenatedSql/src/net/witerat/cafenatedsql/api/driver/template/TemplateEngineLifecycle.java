...
public interface TemplateEngineLifecycle {
	...
	/**
	 * A temmplate service object is about to be discarded
	 */
	void cleanup();
	...
	/**
	 * cafenated SQL or the JVM on which it runs is shutting down. Time to
	 * release resource in an orderly fashion and quickly.
	 */
	void shutdown();
