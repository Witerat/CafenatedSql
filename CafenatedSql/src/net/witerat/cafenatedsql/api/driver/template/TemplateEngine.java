...
/**
 * The Interface TemplateEngine wraps a contract around templating engines
 * so that implementors can exploit templating libraries to provide
 * templating for drivers.
 */
