...
import net.witerat.cafenatedsql.spi.driver.ResourceProtocol;
...
public class DriverLoaderTest {
	...
	public void testLoad() throws JAXBException, MalformedURLException{
		...
		try {
			...
			ParameterTag[] g0n0p = g0n0.getParameters().toArray(new ParameterTag[1]);
			...
			ParameterTag[] g0n0v0p=g0n0v0.getParameters().toArray(new ParameterTag[1]);
			...
			ParameterTag[] g0n0v1p=g0n0v1.getParameters().toArray(new ParameterTag[1]);
			...
			ParameterTag[] g0n1p = g0n1.getParameters().toArray(new ParameterTag[1]);
			...
			ParameterTag[] g0n2p = g0n2.getParameters().toArray(new ParameterTag[1]);
			...
			ParameterTag[] g0n2v0p=g0n2v0.getParameters().toArray(new ParameterTag[4]);
			...
			ParameterTag[] g0n2v1p=g0n2v1.getParameters().toArray(new ParameterTag[1]);
